<?php
    /*
    Plugin Name: CTL Arcade - Word Finder
    Plugin URI: http://www.codethislab.com/
    Description: Word Finder for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeWordFinder{

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-word-finder";
        private $_szPluginName              = "Word Finder";
        private $_szAspectRatio             = "16:8";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "anagram, drag, multi language, word search, languages, letters, mobile, puzzle, ruzzle, skill, word, word game, multilanguage, kid game, school game, educational";
    ...
    $g_oCTLArcadeWordFinder =  new CTLArcadeWordFinder();
