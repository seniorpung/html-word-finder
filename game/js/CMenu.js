function CMenu(){
    ...
    this.refreshButtonPos = function(iNewX,iNewY){
        ...
        if(_oLanguageSelection !== null){
            _oLanguageSelection.refreshButtonPos(iNewX,iNewY);
        }
    };
    
    this.unload = function(){
        _oLanguageSelection.unload();
        _oButPlay.unload(); 
        _oButPlay = null;
    ...
    this._onButPlayRelease = function(){
        ...
        var iLangSelected = parseInt(s_iLangSelected);
        if(s_iLangSelected === "none" || isNaN(s_iLangSelected) || iLangSelected<0 || iLangSelected>5){
            s_iLangSelected = 0;
