function CCreditsPanel(){
    ...
    this._init = function(){
        ...
        _oMsgText = new createjs.Text(TEXT_CREDITS_DEVELOPED,"46px "+FONT_GAME, "#ffffff");
        ...
        _oLink  = new createjs.Text(TEXT_LINK1,"40px "+FONT_GAME, "#ffffff");
        ...
        _pStartPosExit = {x: CANVAS_WIDTH/2 +290, y: 180};
